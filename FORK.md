...
- **`.github/workflows/build-tiles.yml`** — monthly cron rebakes the pyramid from live sources and commits `web/public/data/tiles/` back to the branch; `deploy-web.yml` then ships it to Netlify.
